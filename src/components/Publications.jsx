  ...
  return (
    <section id="publications" className="py-28 bg-surface px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <h2 ref={heading} className="reveal font-display text-4xl md:text-5xl font-bold text-cream mb-16">Publications</h2>

        {publications.map((pub, i) => (
          <div key={i} ref={card}
               className="reveal border border-white/7 bg-surface-2 p-10 hover:border-gold/25 transition-colors">
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-wrap gap-3 mt-6">
                  <span className="text-xs text-cream-faint border border-white/7 px-3 py-1.5 font-mono">DOI: {pub.doi}</span>
                  <a href={pub.link} target="_blank" rel="noopener noreferrer"
