...
export const experience = [
  {
    ...
    description: 'Building scalable ETL/ELT pipelines, financial data workflows, analytics-ready datasets, and production data solutions. Working with Python, SQL, PySpark, Databricks, Snowflake, Airflow, cloud platforms, data modeling, data quality, CI/CD, monitoring, and secure data processing.',
  ...
  },
  {
    ...
    description: 'Created SQL and Python-based reports, dashboards, and analytical workflows to support academic and operational decision-making. Worked on data cleaning, validation, reporting automation, stakeholder requirements, and analysis.',
  ...
  },
  {
    ...
    description: 'Designed and developed Azure-based data pipelines using Azure Data Factory, ADLS Gen2, Azure Databricks, Azure SQL, Delta Lake, PySpark, and Azure DevOps. Supported API-based ingestion, batch processing, cloud migration, data validation, monitoring, and CI/CD.',
